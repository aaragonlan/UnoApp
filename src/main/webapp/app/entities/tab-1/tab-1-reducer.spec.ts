...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tab-1.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAB1_LIST actions', async () => {
    ...
    it('dispatches FETCH_TAB1 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAB1 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAB1 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAB1 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAB1 actions', async () => {
      const expectedActions = [
        {
