  ...
  return (
    <div>
      <h2 id="tab-1-heading" data-cy="Tab1Heading">
        <Translate contentKey="dosApp.tab1.home.title">Tab 1 S</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="dosApp.tab1.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/tab-1/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="dosApp.tab1.home.createLabel">Create new Tab 1</Translate>
          </Link>
        </div>
      </h2>
        ...
        {tab1List && tab1List.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="dosApp.tab1.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="dosApp.tab1.home.notFound">No Tab 1 S found</Translate>
            </div>
          )
        )}
      </div>
