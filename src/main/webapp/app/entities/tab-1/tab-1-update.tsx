  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="unoApp.tab1.home.createOrEditLabel" data-cy="Tab1CreateUpdateHeading">
            <Translate contentKey="unoApp.tab1.home.createOrEditLabel">Create or edit a Tab1</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('unoApp.tab1.col1')} id="tab-1-col1" name="col1" data-cy="col1" type="text" />
              <ValidatedField label={translate('unoApp.tab1.col2')} id="tab-1-col2" name="col2" data-cy="col2" type="text" />
              <ValidatedField label={translate('unoApp.tab1.col3')} id="tab-1-col3" name="col3" data-cy="col3" type="text" />
